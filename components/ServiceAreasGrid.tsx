          ...
          <li key={city.slug} className="flex">
            <ScrollReveal delay={i * 60} className="flex w-full">
              <Link
                ...
                className="group card-lift flex h-full w-full flex-col overflow-hidden rounded-2xl border border-ink/10 bg-white shadow-card hover:border-chrome/40 hover:shadow-card-lift"
              >
